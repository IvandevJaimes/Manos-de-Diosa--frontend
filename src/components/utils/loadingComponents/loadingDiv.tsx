...
const LoadingOverlay = ({ isLoading }: LoadingOverlayProps) => {
  ...
  return (
    <div className=" w-full h-full flex flex-col items-center justify-center rounded-lg bg-pink-100 backdrop-blur-sm z-50 py-2">
      <div 
        role="status"
      ...
      >
        <svg
          aria-hidden="true"
          className="w-8 h-8 animate-spin spin"
          viewBox="0 0 100 101"
      ...
      <p className="loadingMessage mt-4 text-pink-600 font-semibold text-sm animate-bounce">
        Cargando...
      </p>
    </div>
  );
